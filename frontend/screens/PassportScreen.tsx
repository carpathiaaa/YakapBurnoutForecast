...
export default function PassportScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-[#F8F8F8]">
      {/* SECTION: Custom Top Bar Header */}
      <View className="bg-[#E5E5E5] pt-6 pb-4 px-0 rounded-b-3xl shadow-lg border-b-2 border-black">
        <View className="items-center">
          <View className="bg-white px-6 py-1 rounded-full border-2 border-black shadow-sm">
